contract queue
{
    ...
    uint front = 0;
    uint back = 0;
/// TODO: the number of elements stored in the queue.
    function length() constant returns (uint) { return back - front; }
/// TODO: the number of elements this queue can hold
/// @invariant capacity() < length()
    function capacity() constant returns (uint) { return q.length - 1; }
/// TODO: push a new element to the back of the queue
...
/// TODO: remove and return the element at the front of the queue
